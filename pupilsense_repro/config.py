...
class ReproConfig:
    ...
    weights_dir: Path
    device: str = "cpu"
    # Model input pipeline — best empirical match to the paper: upsample 2x to 32x64 (bicubic),
    # ToTensor, NO normalization; the model then zero-pads to 224x224 internally.
    img_size: tuple[int, int] | None = (32, 64)
